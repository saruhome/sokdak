...
export const en = {
    ...
    faqSearchPlaceholder: 'What do you need help with?',
    ...
    wordSearchPlaceholder: 'What word are you looking for?',
    ...
    unknownError: 'An unknown error occurred. Please try again in a moment.',
    ...
    categorySearchPlaceholder: 'What topic interests you?',
    ...
    noFavoritesYet: "You haven't saved any words or favorited any categories yet",
    ...
    countrySearchPlaceholder: 'Where are you from?',
    ...
    dialectTitle: 'Dialects of Korea',
    todayExpressionSub: 'Real Korean in 3 minutes',
    situationCafe: 'Café',
    situationTransit: 'Getting around',
    situationWork: 'Work',
    situationHealth: 'Health',
    situationSns: 'Social media',
    situationMeal: 'Eating out',
    situationArgument: 'Arguing',
    situationRelationship: 'Relationships',
    situationDaily: 'Everyday',
    situationDialect: 'Dialect',
    ...
    errEmailNotConfirmed: 'Your email is not verified yet. Please check your inbox.',
    signupWelcome: 'Welcome!\nLearn real Korean with SokDak.',
    nicknameHelper: 'This name is shown to other users.',
    confirmPasswordPlaceholder: 'Confirm password',
    errNicknameShort: 'Nickname must be at least 2 characters.',
    ...
    termsAllError: 'Please agree to all required terms.',
    signupPendingBtn: 'Signing up…',
    signupDoneTitle: 'Welcome aboard! 🎉',
    signupDoneBody: 'Welcome to SokDak, {nickname}!\nPlease verify via the email sent to \'{email}\', then log in.',
    haveAccountPrompt: 'Already have an account?',
    notifEmpty: 'No notifications yet',
    notifCommentMsg: ' commented on your post: "{title}"',
    notifLikeMsg: ' liked your post: "{title}"',
