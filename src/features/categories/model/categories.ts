...
export const CATEGORIES: Category[] = [
  ...
  { slug: 'drama',           name: '드라마/\n예능',   nameEn: 'Drama/\nVariety', nameJa: 'ドラマ/\nバラエティ',    nameVi: 'Phim/\nGiải trí',       nameEs: 'Series/\nVariedades',   nameDe: 'Drama/\nShows',           emoji: '🎬',  description: '드라마·영화·예능 속 유행 표현',           colorBg: '#E8E8E8', colorFg: '#666666', image: require('../../../../assets/categories/drama.jpg') },
