...
export const CATEGORIES: Category[] = [
  ...
  { slug: 'variety',         name: 'TV쇼',           nameEn: 'TV Shows',        nameJa: 'TV番組',                nameVi: 'Show truyền hình',      nameEs: 'Programas de TV',       nameDe: 'TV-Shows',                nameTr: 'TV şovları', emoji: '📺',  description: '예능·TV쇼에서 나온 유행어',               colorBg: '#F2C4C4', colorFg: '#7A1F1F', image: require('../../../../assets/categories/variety.jpg') },
  ...
  { slug: 'yaminjeongeum',   name: '야민정음',        nameEn: 'Look-alike\nLetters', nameJa: '字形\nいじり', nameVi: 'Chữ\nnhìn giống', nameEs: 'Letras\nparecidas', nameDe: 'Buchstaben-\nspiel', nameTr: 'Harf\noyunu', emoji: '👀', description: '댕댕이·띵곡처럼 글자 모양이 닮은 한글로 바꿔 쓴 말', colorBg: '#C8D8B0', colorFg: '#3E5A1E' },
