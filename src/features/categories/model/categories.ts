...
export const CATEGORIES: Category[] = [
  ...
  { slug: 'love',            name: '연애',            nameEn: 'Dating',          nameJa: '恋愛',                  nameVi: 'Tình yêu',              nameEs: 'Amor',                  nameDe: 'Liebe',                   nameTr: 'Aşk', emoji: '💕',  description: '썸·연애·이별에서 쓰는 신조어',            colorBg: '#E8B8C8', colorFg: '#7A2440' },
