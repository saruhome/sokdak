...
export const EXPRESSIONS: Expression[] = [
  ...
  { situation: 'cafe', ko: '여기 콘센트 있는 자리 있어요?',
    en: 'Is there a seat with a power outlet? (study-café essential)',
    ja: 'コンセント付きの席はありますか?(勉強カフェの必須フレーズ)',
    es: '¿Hay algún asiento con enchufe? (imprescindible en los cafés de estudio)',
    vi: 'Có chỗ nào gần ổ cắm điện không? (câu quen thuộc ở quán cà phê học bài)',
    de: 'Gibt es einen Platz mit Steckdose? (Studiencafé-Klassiker)' },
  ...
  { situation: 'subway', ko: '몇 정거장 남았어?',
    en: 'How many stops left? (casual, to a friend)',
    ja: 'あと何駅?(友達へのタメ口)',
    es: '¿Cuántas paradas faltan? (informal, entre amigos)',
    vi: 'Còn mấy trạm nữa? (thân mật, với bạn bè)',
    de: 'Wie viele Stationen noch? (locker, unter Freunden)' },
  ...
  { situation: 'hospital', ko: '주사 꼭 맞아야 돼요?',
    en: 'Do I really have to get a shot? (casual)',
    ja: '注射、絶対打たないとだめですか?',
    es: '¿De verdad me tienen que poner una inyección?',
    vi: 'Nhất định phải tiêm ạ?',
    de: 'Muss ich wirklich eine Spritze bekommen?' },
