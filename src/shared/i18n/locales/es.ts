...
export const es = {
    ...
    faqSearchPlaceholder: '¿En qué te ayudamos?',
    ...
    moreLink: 'Ver más',
    communitySub: 'Lo nuevo de la comunidad',

    totalPrefix: 'Total',
    categoriesSuffix: 'categorías',
    wordsSuffix: 'palabras',
    sortPopular: 'Popular',
    sortAlphabetical: 'Alfabético (가나다)',

    sortRecent: 'Más recientes',
    sortConsonant: 'Por consonante inicial (ㄱㄴㄷ)',
    categoryFilterLabel: 'Categoría',
    allLabel: 'Todos',
    noSearchResults: 'No se encontraron resultados',
    wordSearchPlaceholder: '¿Qué palabra buscas?',
    ...
    categoryLikeLimitReachedMessage: 'Los miembros gratuitos pueden marcar hasta 2 categorías como favoritas. Pásate a Premium para favoritos ilimitados.',
    ttsLimitReachedTitle: 'Has agotado tus reproducciones de hoy',
    ttsLimitReachedMessage: 'Los miembros gratuitos pueden escuchar 3 pronunciaciones al día. Pásate a Premium para escuchar sin límite.',
    ...
    unknownError: 'Ocurrió un error desconocido. Inténtalo de nuevo en un momento.',
    ...
    boardDescQuestion: 'Pregunta lo que sea sobre jerga o coreano',
    boardDescFree: 'Presentaciones y charla: todo es bienvenido',
    ...
    linkModalTitle: 'Agregar enlace',
    linkUrlPlaceholder: 'https://example.com',
    linkLabelPlaceholder: 'Texto del enlace (opcional)',
    linkInsert: 'Agregar',
    linkUrlRequiredMessage: 'Por favor, ingresa una URL.',
    boldLabel: 'Negrita',
    italicLabel: 'Cursiva',
    ...
    categorySearchPlaceholder: '¿Qué tema te interesa?',
    ...
    noFavoritesYet: 'Aún no has guardado palabras ni marcado categorías como favoritas',
    ...
    countrySearchPlaceholder: '¿De dónde eres?',
    ...
    nicknameRequiredMessage: 'Por favor, ingresa un apodo.',
    ...
    reportReasonRequiredMessage: 'Por favor, ingresa un motivo para el reporte.',
    ...
    reportReasonPlaceholder: 'Agrega detalles si los tienes (opcional)',
    ...
    saveLimitReachedMessage: 'Los miembros gratuitos pueden guardar hasta 3 palabras. Pásate a Premium para guardado ilimitado.',
    dictionaryPremiumBannerText: 'Hazte Premium y guárdalo todo',

    todayExpressionTitle: 'Expresión real de hoy',
    dialectTitle: 'Dialectos de Corea',
    ...
    situationMeal: 'Comidas',
    situationArgument: 'Discusión',
    situationRelationship: 'Relaciones',
    situationDaily: 'Día a día',
    situationDialect: 'Dialecto',
    ...
    adultMeaningLocked: 'Este significado se muestra tras verificar tu edad',
    ...
    loginWelcome: '¡Qué gusto verte de nuevo!\nInicia sesión con tu email.',
    passwordPlaceholder: 'Introduce tu contraseña',
    forgotPasswordLink: '¿Olvidaste tu contraseña?',
    loginPendingBtn: 'Iniciando sesión…',
    resetSentTitle: '¡Email enviado!',
    resetSentDesc: 'Enviamos un enlace de restablecimiento a\n\'{email}\'.\nRevisa tu bandeja de entrada.',
    backToLogin: 'Volver al inicio de sesión',
    forgotIntro: 'Introduce el email con el que te registraste\ny te enviaremos un enlace de restablecimiento.',
    resetSendBtn: 'Enviar enlace',
    resetSendingBtn: 'Enviando…',
    errEmailFormat: 'Introduce un email válido.',
    errPasswordRequired: 'Introduce tu contraseña.',
    errInvalidCredentials: 'Email o contraseña incorrectos.',
    errEmailNotConfirmed: 'Tu email aún no está verificado. Revisa tu bandeja de entrada.',
    signupWelcome: '¡Bienvenido!\nAprende coreano real con SokDak.',
    nicknameHelper: 'Este nombre se muestra a otros usuarios.',
    confirmPasswordPlaceholder: 'Confirmar contraseña',
    errNicknameShort: 'El apodo debe tener al menos 2 caracteres.',
    errPasswordLength: 'La contraseña debe tener al menos 8 caracteres.',
    errPasswordMismatch: 'Las contraseñas no coinciden.',
    errEmailTaken: 'Este email ya está registrado.',
    termsAgree: 'Acepto los Términos de servicio.',
    privacyAgree: 'Acepto la Política de privacidad.',
    requiredMark: '(obligatorio)',
    termsAllError: 'Acepta todos los términos obligatorios.',
    signupPendingBtn: 'Registrando…',
    signupDoneTitle: '¡Registro completado! 🎉',
    signupDoneBody: '¡Bienvenido a SokDak, {nickname}!\nVerifica el correo enviado a \'{email}\' y luego inicia sesión.',
    haveAccountPrompt: '¿Ya tienes cuenta?',
    notifEmpty: 'Aún no hay notificaciones',
    notifCommentMsg: ' comentó tu publicación: "{title}"',
    notifLikeMsg: ' le gustó tu publicación: "{title}"',
