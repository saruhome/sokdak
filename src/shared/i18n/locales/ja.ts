...
export const ja = {
    ...
    collapseLabel: '折りたたむ',
    noFavoritesYet: 'まだ保存した単語やお気に入りのカテゴリーがありません',
    ...
    signupTitle: '会員登録',
    forgotPasswordTitle: 'パスワードを探す',
    loginWelcome: 'また会えて嬉しいです！\nメールでログインしてください。',
    passwordPlaceholder: 'パスワードを入力してください',
    forgotPasswordLink: 'パスワードをお忘れですか？',
    loginPendingBtn: 'ログイン中…',
    resetSentTitle: 'メールを送りました！',
    resetSentDesc: '\'{email}\'宛に\nパスワード再設定リンクを送りました。\nメールボックスをご確認ください。',
    backToLogin: 'ログインに戻る',
    forgotIntro: '登録したメールアドレスを入力すると\nパスワード再設定リンクをお送りします。',
    resetSendBtn: '再設定リンクを送る',
    resetSendingBtn: '送信中…',
    errEmailFormat: '正しいメール形式を入力してください。',
    errPasswordRequired: 'パスワードを入力してください。',
    errInvalidCredentials: 'メールまたはパスワードが正しくありません。',
    errEmailNotConfirmed: 'メール認証がまだ完了していません。受信トレイをご確認ください。',
    signupWelcome: 'はじめまして！\nソクダクと一緒にリアルな韓国語を学びましょう。',
    nicknameHelper: '他のユーザーに表示される名前です。',
    confirmPasswordPlaceholder: 'パスワード確認',
    errNicknameShort: 'ニックネームは2文字以上入力してください。',
    errPasswordLength: 'パスワードは8文字以上にしてください。',
    errPasswordMismatch: 'パスワードが一致しません。',
    errEmailTaken: 'すでに登録されているメールです。',
    termsAgree: '利用規約に同意します。',
    privacyAgree: 'プライバシーポリシーに同意します。',
    requiredMark: '（必須）',
    termsAllError: '必須の規約すべてに同意してください。',
    signupPendingBtn: '登録中…',
    signupDoneTitle: '登録完了！🎉',
    signupDoneBody: '{nickname}さん、ソクダクへようこそ！\n\'{email}\'に送った認証メールを確認してからログインしてください。',
    haveAccountPrompt: 'すでにアカウントをお持ちですか？',
    notifEmpty: 'まだ通知はありません',
    notifCommentMsg: 'さんがあなたの投稿にコメントしました: "{title}"',
    notifLikeMsg: 'さんがあなたの投稿にいいねしました: "{title}"',
    timeJustNow: 'たった今',
    timeMinutes: '{n}分',
    timeHours: '{n}時間',
    timeDays: '{n}日',
