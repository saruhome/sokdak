...
export const ko = {
    ...
    guestCalloutBenefit: '궁금한 표현을 질문해 보세요',
    ...
    adultMeaningLocked: '성인 인증 후 볼 수 있는 뜻이에요',
    ...
    loginPendingBtn: '로그인 중…',
    resetSentTitle: '메일을 보냈어요!',
    resetSentDesc: '\'{email}\'로\n비밀번호 재설정 링크를 보냈어요.\n메일함을 확인해주세요.',
    backToLogin: '로그인으로 돌아가기',
    forgotIntro: '가입하신 이메일 주소를 입력하시면\n비밀번호 재설정 링크를 보내드려요.',
    resetSendBtn: '재설정 링크 보내기',
    resetSendingBtn: '전송 중…',
    errEmailFormat: '올바른 이메일 형식을 입력해주세요.',
    errPasswordRequired: '비밀번호를 입력해주세요.',
    errInvalidCredentials: '이메일 또는 비밀번호가 올바르지 않아요.',
    errEmailNotConfirmed: '이메일 인증이 아직 완료되지 않았어요. 받은 메일함을 확인해주세요.',
    signupWelcome: '반가워요!\n속닥과 함께 진짜 한국어를 배워봐요.',
    nicknameHelper: '다른 사용자에게 표시되는 이름이에요.',
    confirmPasswordPlaceholder: '비밀번호 확인',
    errNicknameShort: '닉네임은 2자 이상 입력해주세요.',
    errPasswordLength: '비밀번호는 8자 이상이어야 해요.',
    errPasswordMismatch: '비밀번호가 일치하지 않아요.',
    errEmailTaken: '이미 가입된 이메일이에요.',
    termsAgree: '이용약관에 동의합니다.',
    privacyAgree: '개인정보 처리방침에 동의합니다.',
    requiredMark: '(필수)',
    termsAllError: '필수 약관에 모두 동의해주세요.',
    signupPendingBtn: '가입 중…',
    signupDoneTitle: '가입 완료! 🎉',
    signupDoneBody: '{nickname}님, 속닥에 오신 걸 환영해요!\n\'{email}\'로 보낸 인증 메일을 확인한 뒤 로그인해주세요.',
    haveAccountPrompt: '이미 계정이 있나요?',
    notifEmpty: '아직 알림이 없어요',
    notifCommentMsg: '님이 회원님의 글에 댓글을 남겼어요: "{title}"',
    notifLikeMsg: '님이 회원님의 글을 좋아합니다: "{title}"',
    timeJustNow: '방금',
    timeMinutes: '{n}분',
    timeHours: '{n}시간',
    timeDays: '{n}일',
