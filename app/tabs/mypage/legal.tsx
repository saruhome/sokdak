...
const styles = StyleSheet.create({
  ...
  itemTitle: { fontSize: 15, fontFamily: 'NotoSerifKR_600SemiBold', color: Colors.textPrimary },
  itemDescription: { fontSize: 12, lineHeight: 17, color: Colors.textSecondary },
  pendingText: { fontSize: 11, color: Colors.point1, fontFamily: 'NotoSerifKR_600SemiBold' },
  supportRow: {
    flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 7,
    paddingVertical: 14, borderRadius: 10, backgroundColor: Colors.divider,
  },
  supportText: { fontSize: 14, fontFamily: 'NotoSerifKR_600SemiBold', color: Colors.textSecondary },
});
