...
const SUPPORTED_LANGUAGES: Language[] = ['ko', 'en', 'ja', 'vi', 'es', 'de'];
...
const TRANSLATIONS: Record<Language, Record<TranslationKey, string>> = {
  ko: {
    ...
    noCategoryResults: '“{query}”에 대한 검색 결과가 없습니다.',
  ...
  en: {
    ...
    sortRecent: 'Recent',
    sortConsonant: 'Korean consonant (ㄱㄴㄷ)',
  ...
  de: {
    ...
    suggestDefinitionLabel: 'Bedeutung (mind. 5 Zeichen)',
    ...
    newSlangSub: 'Entdecke den neuesten Slang',
    moreLink: 'Mehr',
    communitySub: 'Neue Beiträge entdecken',
    ...
    reportReasonPlaceholder: 'Grund eingeben',
    ...
    dictionaryPremiumBannerText: 'Unbegrenzt speichern und Offline-Wörterbuch mit Premium',

    todayExpressionTitle: 'Heutiger Alltagsausdruck',
    todayExpressionSub: '3 Minuten genügen – Koreanisch, das du sofort verwenden kannst',
    situationCafe: 'Café',
