...
const styles = StyleSheet.create({
  ...
  noticeTitle: { fontSize: 16, fontFamily: 'NotoSerifKR_600SemiBold', color: Colors.textPrimary },
  ...
  guidelineNumber: {
    ...
    fontSize: 12, lineHeight: 22, fontFamily: 'NotoSerifKR_600SemiBold', color: Colors.navBarIconActive, backgroundColor: Colors.navBar,
  },
  ...
  checkText: { flex: 1, fontSize: 14, color: Colors.textPrimary, fontFamily: 'NotoSerifKR_600SemiBold' },
  ...
  acceptBtnText: { fontSize: 15, fontFamily: 'NotoSerifKR_600SemiBold', color: Colors.navBarIconActive },
