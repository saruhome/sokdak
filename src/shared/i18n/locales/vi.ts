...
export const vi = {
    ...
    suggestCategoryLabel: 'Danh mục (không bắt buộc)',
    suggestDefinitionLabel: 'Ý nghĩa (không bắt buộc, không biết cũng không sao)',
    suggestDefinitionPlaceholder: 'Giải thích ý nghĩa của từ này',
    suggestExampleLabel: 'Ví dụ (không bắt buộc)',
    ...
    loginPrompt: 'Đăng nhập để bắt đầu',
    ...
    faqSearchPlaceholder: 'Bạn cần giúp gì?',
    ...
    moreLink: 'Xem thêm',
    communitySub: 'Bài mới từ cộng đồng',

    totalPrefix: 'Tổng',
    categoriesSuffix: 'danh mục',
    wordsSuffix: 'từ',
    sortPopular: 'Phổ biến',
    sortAlphabetical: 'Thứ tự 가나다',
    ...
    wordSearchPlaceholder: 'Bạn đang tìm từ gì?',
    ...
    boardDescQuestion: 'Hỏi bất cứ điều gì về tiếng lóng, tiếng Hàn',
    boardDescFree: 'Giới thiệu bản thân, tán gẫu — gì cũng được',
    ...
    writeLanguageNudge: 'Hãy thử viết bằng tiếng Hàn, sai cũng không sao! Viết bằng tiếng mẹ đẻ cũng được.',
    ...
    linkLabelPlaceholder: 'Tên liên kết (không bắt buộc)',
    linkInsert: 'Thêm',
    ...
    categorySearchPlaceholder: 'Bạn quan tâm chủ đề nào?',
    ...
    noFavoritesYet: 'Chưa có từ đã lưu hoặc danh mục yêu thích nào',
    ...
    countrySearchPlaceholder: 'Bạn đến từ đâu?',
    ...
    adultGateBody: 'Nội dung này chứa tiếng lóng thô tục và nội dung người lớn. Chỉ dành cho người từ 19 tuổi trở lên.',
    ...
    globalSearchDidYouMean: 'Ý bạn là “{word}”?',
    mockCheckoutTitle: 'Xác nhận đơn hàng',
    mockCheckoutNotice: 'CHẾ ĐỘ THỬ NGHIỆM — bạn sẽ không bị tính phí',
    mockCheckoutProduct: 'Gói SokDak Premium',
    mockCheckoutPerMonth: 'tháng',
    mockCheckoutPay: 'Thanh toán (thử nghiệm)',
    ...
    premiumPendingBody: 'Thanh toán sẽ khả dụng sau khi hoàn tất tích hợp thanh toán cửa hàng và xác minh máy chủ. Màn hình này không thay đổi hạng thành viên của bạn.',
    ...
    dialectTitle: 'Phương ngữ Hàn Quốc',
    ...
    loginWelcome: 'Rất vui được gặp lại!\nHãy đăng nhập bằng email.',
    passwordPlaceholder: 'Nhập mật khẩu',
    forgotPasswordLink: 'Quên mật khẩu?',
    loginPendingBtn: 'Đang đăng nhập…',
    resetSentTitle: 'Đã gửi email!',
    resetSentDesc: 'Đã gửi liên kết đặt lại mật khẩu tới\n\'{email}\'.\nVui lòng kiểm tra hộp thư.',
    backToLogin: 'Quay lại đăng nhập',
    forgotIntro: 'Nhập email bạn đã đăng ký,\nchúng tôi sẽ gửi liên kết đặt lại mật khẩu.',
    resetSendBtn: 'Gửi liên kết đặt lại',
    resetSendingBtn: 'Đang gửi…',
    errEmailFormat: 'Vui lòng nhập đúng định dạng email.',
    errPasswordRequired: 'Vui lòng nhập mật khẩu.',
    errInvalidCredentials: 'Email hoặc mật khẩu không đúng.',
    errEmailNotConfirmed: 'Email chưa được xác minh. Vui lòng kiểm tra hộp thư.',
    signupWelcome: 'Xin chào!\nHọc tiếng Hàn thật cùng SokDak nhé.',
    nicknameHelper: 'Tên này sẽ hiển thị với người dùng khác.',
    confirmPasswordPlaceholder: 'Xác nhận mật khẩu',
    errNicknameShort: 'Biệt danh phải có ít nhất 2 ký tự.',
    ...
    termsAllError: 'Vui lòng đồng ý tất cả điều khoản bắt buộc.',
    signupPendingBtn: 'Đang đăng ký…',
    signupDoneTitle: 'Đăng ký thành công! 🎉',
    signupDoneBody: 'Chào mừng {nickname} đến với SokDak!\nHãy xác minh qua email gửi tới \'{email}\' rồi đăng nhập nhé.',
    haveAccountPrompt: 'Đã có tài khoản?',
    notifEmpty: 'Chưa có thông báo nào',
    notifCommentMsg: ' đã bình luận bài viết của bạn: "{title}"',
    notifLikeMsg: ' đã thích bài viết của bạn: "{title}"',
