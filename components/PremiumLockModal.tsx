...
export function gateLockedWord(word: Word, showLockModal: () => void, detailBase = '/tabs/dictionary', src?: string) {
  const goDetail = () => router.push(`${detailBase}/${word.id}${src ? `?src=${src}` : ''}` as never);
