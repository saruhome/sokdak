...
export const EXPRESSIONS: Expression[] = [
  ...
  { situation: 'dinner', dialect: true, ko: '겁나 맛있어요',
  ...
  { situation: 'dinner', dialect: true, ko: '마이 무라!',
  ...
  { situation: 'dinner', dialect: true, ko: '우리가 남이가',
  ...
  { situation: 'hospital', ko: '요즘 체력이 완전 방전됐어요',
